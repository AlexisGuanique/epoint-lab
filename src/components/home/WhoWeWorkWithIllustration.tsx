    ...
    case "online-sellers":
      return (
        <svg
          ...
          aria-hidden
        >
          <rect x="20" y="28" width="120" height="72" rx="8" fill="#003100" />
          <rect x="28" y="36" width="104" height="48" rx="4" fill="#aa9746" opacity="0.25" />
          ...
          <circle cx="120" cy="52" r="14" fill="#aa9746" />
          <path
            ...
            strokeLinecap="round"
          />
          <rect x="52" y="92" width="56" height="8" rx="4" fill="#aa9746" />
          <path
    ...
    case "retail-brands":
      return (
        <svg
          ...
          aria-hidden
        >
          <rect x="24" y="32" width="112" height="68" rx="6" fill="#003100" />
          <rect x="32" y="40" width="96" height="52" rx="4" fill="#aa9746" opacity="0.2" />
          <path
            d="M56 68c0-8 6-14 14-14h20c8 0 14 6 14 14v12H56V68z"
            fill="#aa9746"
          />
          <rect x="68" y="48" width="24" height="16" rx="3" fill="#ffffff" opacity="0.85" />
          <circle cx="48" cy="88" r="6" fill="#aa9746" />
          <circle cx="112" cy="88" r="6" fill="#aa9746" />
          <path
            d="M60 24h40l6 8H54l6-8z"
            fill="#aa9746"
          />
          <rect x="72" y="56" width="16" height="3" rx="1.5" fill="#003100" opacity="0.6" />
        </svg>
      );
    case "logistics":
      return (
        <svg
          ...
          aria-hidden
        >
          <rect x="16" y="48" width="72" height="40" rx="6" fill="#003100" />
          <rect x="88" y="56" width="48" height="32" rx="4" fill="#aa9746" opacity="0.35" />
          <rect x="96" y="64" width="32" height="16" rx="2" fill="#003100" opacity="0.5" />
          <circle cx="40" cy="96" r="10" fill="#aa9746" />
          <circle cx="40" cy="96" r="4" fill="#ffffff" />
          <circle cx="112" cy="96" r="10" fill="#aa9746" />
          <circle cx="112" cy="96" r="4" fill="#ffffff" />
          <rect x="24" y="56" width="28" height="20" rx="3" fill="#aa9746" opacity="0.5" />
          <path
            d="M52 40h48l12 8H64"
            stroke="#aa9746"
            strokeWidth="3"
          ...
          />
          <rect x="120" y="36" width="24" height="16" rx="3" fill="#aa9746" />
    ...
    case "scaling-businesses":
      return (
        <svg
          ...
          aria-hidden
        >
          <rect x="20" y="88" width="16" height="24" rx="3" fill="#aa9746" opacity="0.5" />
          <rect x="44" y="72" width="16" height="40" rx="3" fill="#aa9746" opacity="0.7" />
          <rect x="68" y="52" width="16" height="60" rx="3" fill="#aa9746" />
          <rect x="92" y="36" width="16" height="76" rx="3" fill="#003100" />
          <rect x="116" y="20" width="16" height="92" rx="3" fill="#aa9746" />
          <path
    ...
    case "growth-ecosystem":
      return (
        <svg
          ...
          aria-hidden
        >
          <rect width="320" height="240" rx="10" fill="#003100" />
          <circle cx="160" cy="120" r="48" fill="#aa9746" opacity="0.2" />
          <circle cx="160" cy="120" r="32" fill="#aa9746" opacity="0.35" />
          <circle cx="160" cy="120" r="18" fill="#aa9746" />
          <rect x="60" y="52" width="48" height="36" rx="6" fill="#aa9746" opacity="0.6" />
          <rect x="212" y="52" width="48" height="36" rx="6" fill="#aa9746" opacity="0.6" />
